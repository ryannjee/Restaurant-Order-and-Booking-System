                ...
                <div class="row">
                    <div class="col-12">	    
                        ...
                        <div class="search-container">
                            <input type="text" id="searchInput" placeholder="&#xf002;  Search for menu information ..." style="font-family:Arial, FontAwesome; margin-bottom: 10px;">                       
                        </div>
                            <div class="card-header">
                                ...
                                <div class="table-container">
                                    <table id="myTable" class="table table-bordered table-striped table-hover" style="width:100%">
                                        ...
                                        <tbody id="tableBody">										                                           
                                        <?php
                                            $sql = "SELECT d.*, dc.c_name, r.res_name FROM dishes d 
                                            INNER JOIN dishes_category dc ON d.c_id = dc.c_id 
                                            INNER JOIN restaurant r ON d.rs_id = r.rs_id 
                                            ORDER BY d.d_id DESC LIMIT $offset, $records_per_page";
                                                    ...
                                                    echo '<tr>
                                                            ...
                                                            <td>
                                                                <div class="col-md-3 col-lg-8 m-b-10">
                                                                    <center><img src="restaurant_images/dishes/' . $rows['img'] . '" class="img-responsive  radius" style="max-height:100px;max-width:150px;" /></center>
                                                                </div>
                                                            </td>                                                                            
                                                            <td>
        ...
        input.addEventListener("keyup", function () {
            ...
            if (found || filter === "") {
                ...
                if (!noUsersRow) {
                    ...
                    noUsersCell.innerHTML = "<center>Dishes cannot be found.</center>";
