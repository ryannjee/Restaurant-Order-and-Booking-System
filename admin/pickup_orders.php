...
$total_query = "SELECT COUNT(*) as total FROM users_orders";
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-primary">
                            <div class="search-container">
                                <input type="text" id="searchInput" placeholder="&#xf002;  Search for take-out orders ..." style="font-family:Arial, FontAwesome; margin-bottom: 10px;">                                                       
                            </div>
                            <br>
                                    ...
                                    <table id="myTable" class="table table-bordered table-striped table-hover" style="width:100%">
                                        ...
                                        <tbody id="tableBody">                                           											
											<?php
                                                ...
                                                ORDER BY users_orders.date DESC LIMIT $offset, $records_per_page";                                        
												...
												if (!mysqli_num_rows($query) > 0) {
                                                    ...
                                                    while ($rows = mysqli_fetch_array($query)) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <?php
                                                            $status = $rows['status'];
                                                            if ($status == 'Order Received' || $status == '' || $status == 'NULL') {
                                                                ?>
                                                            ...
                                                            <?php } ?>
                                                            <?php if ($status == "Order Collected") { ?>
                                                                <td> <button type="button" class="btn btn-success"><span class="fa fa-check-circle" aria-hidden="true"></span> Order Collected</button></td>
                                                            <?php } ?>
                                                            ...
                                                            <td>
                                                                <div class="btn-group" role="group">
                                                                    ...
                                                                    <a href="delete_orders.php?order_del=<?php echo $rows['o_id']; ?>" onclick="return confirm('Are you sure you want to delete the order?');" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10" style="margin-left: 7px;"><i class="fa fa-trash-o" style="font-size:16px"></i></a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                <?php
