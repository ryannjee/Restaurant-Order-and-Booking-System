                            ...
                            <div class="card-header">
                                ...
                                <div class="table-responsive m-t-20">
                                        ...
                                        <tbody>
											...
											<tr>
												...
												<?php 
													...
													{
													?>
														<td><center><button type="button" class="btn btn-success" ><span  class="fa fa-check-circle" aria-hidden="true"></span> Order Collected</button></center></td> 
													<?php 
													} 
													?>
													<?php
                                    ...
                                    <br><div class="form-actions text-center">
                                        <a href="../admin/update_orderstatus.php?user_upd=<?php echo $rows['o_id']; ?>" title="Update order">
										<button type="button" class="btn btn-primary">Update Order Status</button></a>
                                        <a href="pickup_orders.php" class="btn btn-inverse">Back</a>					
                                    </div>
                                </div>
                            </div>
                        </div>
