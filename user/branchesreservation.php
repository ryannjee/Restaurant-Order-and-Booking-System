...
<header id="header" class="header-scroll top-header headrom">
    ...
    <div class="page-wrapper">   
        <section class="hero bg-image" data-image-src="../images/reservation.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Select a Branch (Reservation)</h1>
                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-4 text-xs-center">
                                        <div class="right-content bg-white">
                                            <div class="right-review">                                           
                                                <a href="#" class="btn btn-purple oval-button" onclick="checkLoginAndRedirect(' . $rows['rs_id'] . ');">Book Now</a>                                            </div>
                                        </div>
                                        <!-- end:right info -->
                                    </div>';
                                }
    ...
    <script>
        function checkLoginAndRedirect(reservationId) {
            <?php
            ...
            if (empty($_SESSION["user_id"])) {
                ...
                // Redirect to reservation.php if logged in
                echo 'window.location.href = "../user/reservation.php?res_id=" + reservationId;';
            }
            ?>
        }
    </script>
