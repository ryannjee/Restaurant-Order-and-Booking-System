                                        ...
                                        <div class="food-item">
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-12 col-lg-8">
                                                    <form method="post" action='../user/menudinein.php?res_id=<?php echo $_GET['res_id'];?>&action=add&id=<?php echo $dish['d_id']; ?>'>
                    ...
                    <div class="widget widget-cart">
                        ...
                        <div class="order-row bg-white">
                            <div class="widget-body">
                                ...
                                ?>									
                                <div class="title-row">
                                    <?php echo $item["title"]; ?><a href="../user/menudinein.php?res_id=<?php echo $_GET['res_id']; ?>&action=remove&id=<?php echo $item["d_id"]; ?>" >
                        ...
                        <div class="widget-body">
                            <div class="price-wrap text-xs-center">
                                ...
                                if($item_total==0){
                                ?>
                                <a href="../user/paymentdinein.php?res_id=<?php echo $_GET['res_id'];?>&action=check"  class="btn btn-danger btn-lg disabled">Checkout</a>
                                <?php
                                }
                                else{   
                                ?>
                                <a href="../user/paymentdinein.php?res_id=<?php echo $_GET['res_id'];?>&action=check"  class="btn btn-success btn-lg active">Checkout</a>
                                <?php   
                                }
                                ?>
                            </div>
