                            ...
                            <div class="bg-gray">
                                <div class="row">								
							        <table class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <?php
                                            $query_res = mysqli_query($db, "SELECT uo.o_id, uo.title, r.res_name AS res_name, r.address, dc.c_name, uo.quantity, uo.price, uo.status, uo.date, uo.o_num
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td data-column="Action">
                                                            ...
                                                            if ($status == "Order Received" || $status == "") {
                                                                echo '<a href="../user/delete_orders.php?order_del=' . $row['o_id'] . '" onclick="return confirm(\'Are you sure you want to cancel your order?\');" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"> Cancel Order</i></a>';
                                                            } else {
