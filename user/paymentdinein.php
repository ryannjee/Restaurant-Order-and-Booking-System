...
include_once '../user/menuactiondinein.php';
error_reporting(0);
session_start();
...
function function_alert()
{
    ...
    echo "<script>window.location.replace('../user/ordersdinein.php');</script>";
}
...
if (empty($_SESSION["user_id"])) {
    ...
    if (isset($_POST['submit'])) {
        ...
        foreach ($_SESSION["cart_item"] as $item) {
            ...
            $SQL = "INSERT INTO users_ordersin(u_id, d_id, c_id, rs_id, title, quantity, price, o_num) 
        ...
        <div class="page-wrapper">
            <div class="top-links">
                <div class="container">
                    <ul class="row links">                     
                        ...
                        <li class="col-xs-12 col-sm-4 link-item active" ><span>3</span><a href="../user/paymentdinein.php">Order and Payment</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Order and Payment (Dine In)</h1>                   
                            ...
                            <div class="row">                               
                                <div class="col-sm-12">
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-color"><strong><?php 
                                                        echo $totalQuantity; ?></strong></td>
                                    ...
                                    <div class="payment-option">
                                        ...
                                        <h6>** Please provide the order number in My Orders or via email upon completing the payment at the counter **</h6>
                                        <br>
