...
if (isset($_POST['submit'])) {
    ...
    if (empty($firstname) ||
        ...
        if ($count > 0) {
            ...
            if (isset($_FILES['file']) && $_FILES['file']['error'] === UPLOAD_ERR_OK) {                $FileUploader = new FileUploader($_FILES);
                ...
                <div class="col-md-8 user-information">
                    <form action="../user/userprofileedit.php" method="post" enctype="multipart/form-data">
                        ...
                        ?>
                            ...
                            <input class="form-control" type="text" name="firstname" id="example-text-input" style="text-align: center;" value="<?php echo $userInfo["f_name"]; ?>" readonly><br>

                            <label for="example-text-input-2">Last Name</label>
                            <input class="form-control" type="text" name="lastname" id="example-text-input-2" style="text-align: center;" value="<?php echo $userInfo["l_name"]; ?>" readonly><br>

                            <label for="exampleInputEmail1">Username</label>
                            <input class="form-control" type="text" name="username" id="example-text-input" style="text-align: center;" value="<?php echo $userInfo["username"]; ?>" readonly><br>

                            <label for="exampleInputEmail1">Email Address <span>(e.g. example@hotmail.com)</span></label>
                            <input type="text" class="form-control" name="email" id="exampleInputEmail1" style="text-align: center;" value="<?php echo $userInfo["email"]; ?>" readonly><br>

                            <label for="exampleInputEmail1">Phone Number <span>(e.g. +6012-3456789)</span></label>
                            <input class="form-control" type="text" name="phone" id="example-tel-input-3" style="text-align: center;" value="<?php echo $userInfo["phone"]; ?>" readonly><br>

                            <label for="exampleInputEmail1">Gender</label><br>
                            <input type="radio" name="gender" value="male" id="male" <?php if ($gender === 'male') echo 'checked'; ?> disabled>
                            <label for="male"> Male &nbsp;&nbsp;&nbsp;</label>
                            <input type="radio" name="gender" value="female" id="female" <?php if ($gender === 'female') echo 'checked'; ?> disabled>
                            <label for="female"> Female </label><br><br>

                            <label for="birthday">Birthday</label><br>
                            <input type="date" name="birthday" id="birthday" value="<?php echo $userInfo["birthday"]; ?>" max="<?php echo date('Y-m-d'); ?>" readonly><br><br>

                            <label for="exampleTextarea">Home Address</label>
                            <textarea class="form-control" id="exampleTextarea" name="address" rows="3" readonly><?php echo $userInfo["address"]; ?></textarea><br><br>

                            <div class="col-sm-12 text-center" style="text-align: center;">
                                <div style="display: flex; justify-content: center;">
                                    <input type="submit" value="Edit Profile" name="edit_profile" class="oval-button" style="margin-right: 30px;">
                                    <input type="button" value="Change Password" onclick="redirectToChangePassword()" class="oval-button">
                                </div>
                            </div>
                            <script>
                                function redirectToChangePassword() {
                                    window.location.href = '../forgot/changePassword.php';
                                }
                            </script>
                        </div>
                    </form>
